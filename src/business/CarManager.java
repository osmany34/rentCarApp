    ...
    public ArrayList<Object[]> getForTable(int size, ArrayList<Car> cars) {
        ...
        for (Car obj : cars) {
            ...
            if (obj.getModel() != null) {
                rowObject[i++] = obj.getModel().getBrand() != null ? obj.getModel().getBrand().getName() : null;
                ...
                rowObject[i++] = null; // Model name
                rowObject[i++] = null; // Year
                rowObject[i++] = null; // Type
                rowObject[i++] = null; // Fuel
                rowObject[i++] = null; // Gear
            }
